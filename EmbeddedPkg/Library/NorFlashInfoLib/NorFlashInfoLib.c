...
STATIC CONST NOR_FLASH_INFO  NorFlashIds[] = {
  ...
  { L"mx25u51245g",    { 0xc2, 0x25, 0x3a }, 3, 256, 64 * 1024,  1024, NOR_FLASH_ERASE_4K                       },
  ...
  { L"s25fl512s",      { 0x01, 0x02, 0x20, 0x4d, 0x80}, 5, 256, 256 * 1024, 256,  NOR_FLASH_ERASE_4K                       },
  ...
  { L"w25q512nwm",     { 0xef, 0x80, 0x20 }, 3, 256, 64 * 1024,  1024, NOR_FLASH_ERASE_4K                       },
